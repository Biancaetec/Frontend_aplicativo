...
export function CategoriaProvider({ children }) {
  ...
  const API_URL = 'https://organic-umbrella-jjrr7gxw6q4pfjj5g-3001.app.github.dev/api/categoria';
  //const API_URL = 'https://special-invention-9769xr99qw56hx95x-3001.app.github.dev/api/categoria';
